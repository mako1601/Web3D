...
public class ArticleController(IArticleService articleService) : ControllerBase
{
    ...
    public async Task<IActionResult> CreateAsync([FromBody] ArticleRequest request)
    {
        ...
        await articleService.CreateAsync(authorId, request.Title, request.Description, request.ContentUrl, request.RelatedTestId);
        return NoContent();
    }
    ...
    {
        await articleService.UpdateAsync(id, request.Title, request.Description, request.ContentUrl, request.RelatedTestId);
        return NoContent();
    }
