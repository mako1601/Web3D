...
{
    public Task CreateAsync(long userId, string title, string description, ICollection<Question> questions, long? relatedArticleId, CancellationToken cancellationToken = default);
    ...
    public Task UpdateAsync(long testId, string newTitle, string newDescription, ICollection<Question> questions, long? relatedArticleId, CancellationToken cancellationToken = default);
